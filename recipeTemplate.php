    ...
    <div id="rec-info" class="rec">
      ...
      <section id="directions">
        ...
        <ol id="dir_list">
          <li>
            <h4>Cook the rice:</h4>
            <img class="step_img" src="img/recipes/ancho-orange_chicken/0101_FPP_Chicken-Rice_18594_WEB_high_feature.jpg" alt="Cooking rice">
          ...
          <li>
            ...
            <img class="step_img" src="img/recipes/ancho-orange_chicken/0101_FPP_Chicken-Rice_18622_WEB_high_feature.jpg" alt="Ingredients and glaze">
          ...
          <li>
            ...
            <img class="step_img" src="img/recipes/ancho-orange_chicken/0101_FPP_Chicken-Rice_18626_WEB_high_feature.jpg" alt="Roasing carrots on a sheet pan">
          ...
          <li>
            <h4>Cook the kale:</h4>
            <img class="step_img" src="img/recipes/ancho-orange_chicken/0101_FPP_Chicken-Rice_18609_WEB_high_feature.jpg" alt="Cooking kale in a pan">
          ...
          <li>
            ...
            <img class="step_img" src="img/recipes/ancho-orange_chicken/0101_FPP_Chicken-Rice_18639_WEB_high_feature.jpg" alt="Cooking and glazing chicken in a pan">
          ...
          <li>
            ...
            <img class="step_img" src="img/recipes/ancho-orange_chicken/0101_FPP_Chicken-Rice_18630_WEB_high_feature.jpg" alt="Adding kale to rice pot">
